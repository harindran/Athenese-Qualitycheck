...
Public Class ClsQCActions
    ...
    Public Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            ...
            Dim QCNum As String = ""
            If objForm.Mode = SAPbouiCOM.BoFormMode.fm_FIND_MODE Or pVal.Row = 0 Then Exit Sub
            ...
            Else
                Select Case pVal.EventType
                    ...
                    Case SAPbouiCOM.BoEventTypes.et_COMBO_SELECT
                        ...
                        End If
                    Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                        If pVal.ItemUID = "8" Or pVal.ItemUID = "10" Or pVal.ItemUID = "12" Or pVal.ItemUID = "17" Or (pVal.ItemUID = "20" And pVal.ColUID = "10A" Or pVal.ColUID = "8" Or pVal.ColUID = "9" Or pVal.ColUID = "7C") Then
                            CFL(FormUID, pVal)
                        End If
                    Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                        If pVal.ItemUID = "20" And pVal.ColUID = "0A" Then
                            Dim tick As String = "Y"
                            Dim Row As Integer = 0
                            Try
                                objSelect = objMatrix.Columns.Item("0A").Cells.Item(pVal.Row).Specific
                                QCACTLine.SetValue("U_Select", pVal.Row, tick)
                                Row = pVal.Row
        ...
        Try
            ...
            If objQCStatus.Selected.Value = "Rej" Then
                ...
                Else
                    ...
                    StrQuery += vbCrLf + "FROM [@MIPLQC1] T1 INNER JOIN [@MIPLQC] T0 ON T0.DocEntry=T1.DocEntry)A where A.QCQty>0  and A.U_RejWhse<>'' and  A.U_Vendor<>'' and A.QCType='" & objQCType.Selected.Value & "' "
                End If
            ElseIf objQCStatus.Selected.Value = "Rew" Then
                ...
                Else
                    ...
                    StrQuery += vbCrLf + "FROM [@MIPLQC1] T1 INNER JOIN [@MIPLQC] T0 ON T0.DocEntry=T1.DocEntry)A where A.QCQty>0 and A.U_RewWhse<>'' and  A.U_Vendor<>'' and A.QCType='" & objQCType.Selected.Value & "'  "
                End If
            End If
        ...
        Try
            ...
            Else
                ...
                If objForm.Items.Item("10").Specific.string <> "" Then 'Vendor Code
                    strSQL += vbCrLf + "and A.U_Vendor='" & objForm.Items.Item("10").Specific.string & "'"
                End If
            End If
            objRecordSet = objAddOn.objCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
        ...
        Try
            ...
            If Lineflag = True Then
                ...
                Try
                    ...
                    Row = 1
                    If objAPCMatrix.Columns.Item("U_Item").Editable = False Or objAPCMatrix.Columns.Item("U_Whse").Editable = False Or objAPCMatrix.Columns.Item("U_Qty").Editable = False Then
                    ...
                    For i As Integer = 1 To objMatrix.VisualRowCount
                        objSelect = objMatrix.Columns.Item("0A").Cells.Item(i).Specific
                        If objSelect.Checked = True Then
                            objAPCMatrix.Columns.Item("1").Cells.Item(Row).Specific.String = objMatrix.Columns.Item("3").Cells.Item(i).Specific.string
                            objAPCMatrix.Columns.Item("11").Cells.Item(Row).Specific.String = objMatrix.Columns.Item("6").Cells.Item(i).Specific.string
                            objAPCMatrix.Columns.Item("24").Cells.Item(Row).Specific.String = objMatrix.Columns.Item("5").Cells.Item(i).Specific.string
                            objAPCMatrix.Columns.Item("U_Item").Cells.Item(Row).Specific.String = objMatrix.Columns.Item("3").Cells.Item(i).Specific.string
                            objAPCMatrix.Columns.Item("U_Whse").Cells.Item(Row).Specific.String = objMatrix.Columns.Item("5").Cells.Item(i).Specific.string
                            objAPCMatrix.Columns.Item("U_Qty").Cells.Item(Row).Specific.String = objMatrix.Columns.Item("6").Cells.Item(i).Specific.string
                            Row += 1
                        End If
                    Next
                ...
                If Lineflag = True Then
                    ...
                    For i As Integer = 1 To objMatrix.VisualRowCount
                        ...
                        If objSelect.Checked = True Then
                            ...
                            Batch = objAddOn.objGenFunc.getSingleValue("select ManBtchNum from OITM WHERE ItemCode='" & objMatrix.Columns.Item("3").Cells.Item(i).Specific.string & "'")
                            Quantity = CDbl(objMatrix.Columns.Item("6").Cells.Item(i).Specific.string)
                            objstocktransfer.Lines.ItemCode = objMatrix.Columns.Item("3").Cells.Item(Row).Specific.string
                            objstocktransfer.Lines.Quantity = Quantity
                            objstocktransfer.Lines.FromWarehouseCode = objMatrix.Columns.Item("5").Cells.Item(Row).Specific.string 'objForm.Items.Item("25").Specific.string
                            objstocktransfer.Lines.WarehouseCode = objMatrix.Columns.Item("7C").Cells.Item(Row).Specific.string ' ToWhse
                            objcc = GetCostCenter(objMatrix.Columns.Item("1A").Cells.Item(Row).Specific.string, Row, objMatrix.Columns.Item("1B").Cells.Item(Row).Specific.string)
